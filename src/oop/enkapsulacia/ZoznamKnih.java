...
public class ZoznamKnih {
    public static void main(String[] args) {
        ...
        for(Kniha konkretnaKniha:knihy) {
            // System.out.println(konkretnaKniha); // Vypise pre cloveka nezrozumitelny text ako napr. oop.enkapsulacia.Kniha@1be6f5c3 a oop.enkapsulacia.Kniha@6b884d57
            System.out.println(); // Prazdny riadok
            System.out.println("Názov knihy: " + konkretnaKniha.nazov);
            System.out.println("Autora knihy: " + konkretnaKniha.autor);
